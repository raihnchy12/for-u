...
if(totalAwal > 40000) {
   ...
   alert (`Sayangg kamu dapet diskon dari aku senilai Rp${nilaiDiskon.toLocaleString('ID-id')}\njadi kamu cukup bayar: Rp${hargaBayar.toLocaleString('ID-id')}`)
...
setTimeout(() => {
   displayArea.innerHTML = `
      <div class="struk">
            ...
            <h2 style="color: #ff69b4";>Bayar: Rp${hargaBayar.toLocaleString('ID-id')} </h2>
            <hr>
